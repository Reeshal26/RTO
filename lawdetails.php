...
{
	$id=intval($_GET['del']);
	$adn="delete from law where id=$id";
		$stmt= $mysqli->query($adn);
			...
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-12"></br></br>
						<h2 class="page-title">View law</h2>
						<div class="panel panel-default">
							<div class="panel-heading">All law Details</div>
...
<a href="lawdetails.php?del=<?php echo $row['id'];?>" title="Delete Record" onclick="return confirm("Do you want to delete");"></a></td>
										</tr>
									<?php
$cnt=$cnt+1;
									 } ?>
